...
#define PT_KERN_TO_PHYS(addr) ((uint64_t*)((char*)addr - VA_OFFSET))

#define PHYS_TO_KERN(addr) ((void*)((char*)addr + VA_OFFSET))
#define KERN_TO_PHYS(addr) ((void*)((char*)addr + VA_OFFSET))
